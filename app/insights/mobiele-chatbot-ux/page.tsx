...
export const metadata: Metadata = {
  title: 'De onzichtbare drempel: Waarom jouw chatbot klanten wegjaagt | Sproscale Insights',
  description: 'Een AI-chatbot zonder goede mobiele UX kost je conversies. Leer hoe het jumping keyboard probleem klanten wegjaagt en hoe Sproscale dit oplost.',
};
